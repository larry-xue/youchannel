    ...
    <section className="flex flex-col items-center justify-center gap-16 py-16 text-center animate-rise lg:py-24">
      <div className="flex max-w-3xl flex-col items-center space-y-8">
        ...
        <div className="flex flex-wrap justify-center gap-6 pt-4 text-sm font-medium text-muted-foreground">
          <div className="flex items-center gap-2 rounded-full bg-secondary/30 border border-border/40 px-4 py-1.5 backdrop-blur-sm">
            <div className="h-2 w-2 rounded-full bg-chart-2 shadow-sm" />
            {m.feature_any_language()}
          </div>
          <div className="flex items-center gap-2 rounded-full bg-secondary/30 border border-border/40 px-4 py-1.5 backdrop-blur-sm">
            <div className="h-2 w-2 rounded-full bg-chart-1 shadow-sm" />
            {m.feature_ai_chat()}
          </div>
          <div className="flex items-center gap-2 rounded-full bg-secondary/30 border border-border/40 px-4 py-1.5 backdrop-blur-sm">
      ...
      <div className="relative w-full max-w-5xl px-4">
        <div className="absolute -inset-4 -z-10 rounded-[3rem] bg-gradient-to-tr from-primary/20 via-chart-2/10 to-transparent blur-3xl dark:via-chart-4/20" />

        <div className="relative overflow-hidden rounded-3xl bg-card/40 shadow-2xl ring-1 ring-border/50 backdrop-blur-md transition-[box-shadow,background-color,border-color] hover:ring-primary/20">
          <div className="aspect-[21/9] bg-muted/20 p-4 sm:p-6 flex items-center justify-center">
            <div className="flex h-full w-full flex-col items-center justify-center rounded-2xl bg-card/60 text-center text-muted-foreground ring-1 ring-border/20 backdrop-blur-sm p-8 sm:p-12">
